...
class EvaluationDataset(Dataset):
    ...
    def __init__(self, dataroot, size = [256,256],pairs_list=None):
        ...
        if 'best_frame' in pairs:
            self.anchors = pairs['best_frame'].tolist()
        else:
    ...
    def __getitem__(self, idx):
        ...
        source = T.Resize(self.frame_shape)(source)
        ...
        driving = T.Resize(self.frame_shape)(driving)
        ...
        anchor = T.Resize(self.frame_shape)(anchor)
