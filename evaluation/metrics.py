...
def two_folders(path_gt, path_generated):
    ...
    print("Detected %d images in Generated folder   %s" % (len(filenames_path_generated), path_generated))
...
if __name__ == "__main__":
    ...
    # if opt.mode == 'folders':
    two_folders('log/Unet_PartitionMemoryUnitV3_no_adv/vox_same_id/gt', 'log/Unet_PartitionMemoryUnitV3_no_adv/vox_same_id/generate')

    # two_folders('log/Unet_PartitionMemoryUnitV3_div4/vox_same_id/gt', 'log/Unet_PartitionMemoryUnitV3_div4/vox_same_id/generate')
    # two_folders('/data/fhongac/workspace/src/DaGAN_Origin/log/vox-adv-256rgbd_kp_num15_rgbd_attnv2/vox_same_id/gt', '/data/fhongac/workspace/src/DaGAN_Origin/log/vox-adv-256rgbd_kp_num15_rgbd_attnv2/vox_same_id/generate')
    # two_folders('/data/fhongac/workspace/gitrepo/first-order-model/checkpoint/vox_same_id/gt', '/data/fhongac/workspace/gitrepo/first-order-model/checkpoint/vox_same_id/generate')
